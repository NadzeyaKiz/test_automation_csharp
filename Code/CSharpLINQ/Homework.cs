namespace CSharpLINQ
{
    public class Homework
    {
        ...
        public void Task_08()
        {
            ...
            Console.WriteLine($"The sum of the lengths of all elements of the collection [{string.Join(", ", poemWords)}] is: {totalLength}");
            if (totalLength > 5)
            {
                Console.WriteLine("The first elemet is: " + poemWords.First());
                Console.WriteLine("The last element is: " + poemWords.Last());
            }
        }        
    }
}
